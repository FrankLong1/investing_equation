...
An open framework for turning source-linked investment research into reviewable portfolio decisions. External evidence is filtered and compressed into market views, variant theses, expected payoffs, selection, sizing, timing, and outcome reviews.
...
Run `python3 scripts/validate-skill-routing.py` to check routing coverage.
