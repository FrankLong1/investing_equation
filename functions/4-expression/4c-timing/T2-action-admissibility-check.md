# T2. Action Admissibility Check

Status: contract stub. Stage: [4C. Timing](README.md). Primitive: `filter`.

Authoritative behavior: [timing-posture-build](../../../skills/timing-posture-build/SKILL.md) and [routing](../../../skills/ROUTING.md). This file does not replace either source yet.
