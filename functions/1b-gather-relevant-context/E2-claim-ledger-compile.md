# E2. Claim Ledger Compile

Status: contract stub. Stage: [1B. Gather Relevant Context](README.md). Primitive: `compress`.

Authoritative behavior: [evidence-intake](../../skills/evidence-intake/SKILL.md) and [routing](../../skills/ROUTING.md). This file does not replace either source yet.
