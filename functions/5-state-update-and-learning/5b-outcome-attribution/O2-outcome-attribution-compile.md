# O2. Outcome Attribution Compile

Status: contract stub. Stage: [5B. Outcome Attribution](README.md). Primitive: `compress`.

Authoritative behavior: [outcome-review](../../../skills/outcome-review/SKILL.md) and [routing](../../../skills/ROUTING.md). This file does not replace either source yet.
