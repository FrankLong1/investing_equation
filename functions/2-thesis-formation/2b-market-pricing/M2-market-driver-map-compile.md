# M2. Market Driver Map Compile

Status: contract stub. Stage: [2B. Understand Market Pricing](README.md). Primitive: `compress`.

Authoritative behavior: [market-view-reconstruction](../../../skills/market-view-reconstruction/SKILL.md) and [routing](../../../skills/ROUTING.md). This file does not replace either source yet.
