# R1. Recognition Path Compile

Status: contract stub. Stage: [2C. Form a Variant View](README.md). Primitive: `compress`.

Authoritative behavior: [recognition-path-build](../../../skills/recognition-path-build/SKILL.md) and [routing](../../../skills/ROUTING.md). This file does not replace either source yet.
