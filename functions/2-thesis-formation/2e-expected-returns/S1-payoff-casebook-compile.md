# S1. Payoff Casebook Compile

Status: contract stub. Stage: [2E. Calculate Expected Returns](README.md). Primitive: `compress`.

Authoritative behavior: [sizing-input-build](../../../skills/sizing-input-build/SKILL.md) and [routing](../../../skills/ROUTING.md). This file does not replace either source yet.
